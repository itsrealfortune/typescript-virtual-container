...
export { assertPathAccess, checkFilePermission, resolvePath, resolveReadablePath } from "./commands/helpers";
...
export { bootstrapLinuxRootfs, getStaticRootfsSnapshot, refreshProc, syncEtcPasswd } from "./modules/linuxRootfs";
...
export { decodeVfs, encodeVfs, forkDirTree, isBinarySnapshot } from "./modules/VirtualFileSystem/binaryPack";
...
export { enforceAccess, enforceChmod, enforceChown, enforceDelete, enforcePathTraversal, isExecutable, R_OK, resolveEffectiveGid, resolveEffectiveUid, W_OK, X_OK } from "./modules/VirtualFileSystem/permissions";
export { SwapStore } from "./modules/VirtualFileSystem/swapStore";
export type { SwapStats } from "./modules/VirtualFileSystem/swapStore";
export { randomMac, VirtualNetworkManager } from "./modules/VirtualNetworkManager";
...
export type { GcStats, IdleManagerOptions, IdleState } from "./modules/VirtualShell/idleManager";
export { VirtualShell } from "./modules/VirtualShell/index";
export type { ShellProperties, VirtualShellResourceCaps, VirtualShellVfsLike, VirtualShellVfsOptions } from "./modules/VirtualShell/index";
...
export { ProcessScheduler, VirtualUserManager } from "./modules/VirtualUserManager/index";
export type { ProcessPriority, ProcessStatus, SchedulerAction, SchedulerConfig, SchedulerStats, VirtualActiveSession, VirtualProcess, VirtualUserRecord } from "./modules/VirtualUserManager/index";
export { resolveSignal, signalDefaultAction, SIGNALS } from "./modules/VirtualUserManager/signals";
export type { SignalHandler, SignalName } from "./modules/VirtualUserManager/signals";
...
export type {
	...
	MountPoint,
	RemoveOptions,
	VfsBaseNode, VfsCacheEvictionPolicy, VfsCacheOptions,
	VfsCacheStats, VfsDeviceNode, VfsDirectoryNode, VfsDiskIoParams, VfsFileNode, VfsNodeStats,
	VfsNodeType,
	VfsSnapshot,
	VfsSnapshotBaseNode, VfsSnapshotDeviceNode, VfsSnapshotDirectoryNode,
	VfsSnapshotFileNode, VfsSnapshotNode,
	WriteFileOptions
} from "./types/vfs";
export { evalArith, expandAsync, expandBraces, expandGlob, expandSync } from "./utils/expand";
...
export { listPathCompletions, loadHistory, readLastLogin, saveHistory, writeLastLogin } from "./utils/shellSession";
