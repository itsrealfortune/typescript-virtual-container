...
# Architecture — typescript-virtual-container v1.7.2
...
|---|---|---|---|
| `fortune-nyx-v1.7.2-directbash-k6.1.0.mjs` | 3,882 | ESM | Direct bash bundle (Node.js) |
| `fortune-nyx-v1.7.2-ssh.cjs` | 3,876 | CJS | SSH server bundle |
| `fortune-nyx-v1.7.2-web.min.js` | 35,254 | ESM (minified) | Web browser shell |
...
| **Latest tag** | `v1.7.2` |
| **Total tags** | 50+ (from `v1.0.0` through `v1.7.2`) |
| **Local branches** | 62 |
