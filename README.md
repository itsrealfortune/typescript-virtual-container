...
| **Web shell** | `builds/fortune-nyx-v1.5.2-web.min.js` (ESM) | Embedded terminals, interactive tutorials, browser demos |
| **Standalone CLI** | `builds/fortune-nyx-v1.5.2-directbash-k6.1.0.mjs` (single file) | Local shell, one-liner demos, no install required |
<!-- /BUILD:mode-table -->
...
```bash
curl -s https://raw.githubusercontent.com/itsrealfortune/typescript-virtual-container/refs/heads/main/builds/fortune-nyx-v1.5.2-directbash-k6.1.0.mjs -o fortune-nyx-v1.5.2-directbash-k6.1.0.mjs && node fortune-nyx-v1.5.2-directbash-k6.1.0.mjs
```

#### SSH server (connect with any SSH client on port 2222)
```bash
curl -s https://raw.githubusercontent.com/itsrealfortune/typescript-virtual-container/refs/heads/main/builds/fortune-nyx-v1.5.2-ssh.cjs -o fortune-nyx-v1.5.2-ssh.cjs && node fortune-nyx-v1.5.2-ssh.cjs
```

#### SSH server without SFTP (lighter build)
```bash
curl -s https://raw.githubusercontent.com/itsrealfortune/typescript-virtual-container/refs/heads/main/builds/fortune-nyx-v1.5.2-ssh-nosftp.js -o fortune-nyx-v1.5.2-ssh-nosftp.js && node fortune-nyx-v1.5.2-ssh-nosftp.js
```
<!-- /BUILD:curl-start -->
...
**`fortune-nyx-v1.5.2-directbash-k6.1.0.mjs` options:**

```bash
node fortune-nyx-v1.5.2-directbash-k6.1.0.mjs                  # boot as root
node fortune-nyx-v1.5.2-directbash-k6.1.0.mjs --user alice     # boot as alice (prompts for password if set)
node fortune-nyx-v1.5.2-directbash-k6.1.0.mjs --user=alice     # same, inline form
SSH_MIMIC_HOSTNAME=my-box node fortune-nyx-v1.5.2-directbash-k6.1.0.mjs  # custom hostname
```
<!-- /BUILD:selfStandalone-options -->
...
|--------|--------|-------------|----------|
| `builds/fortune-nyx-v1.5.2-web.min.js` | ESM | `createWebShell()` | Embedded terminals, modern bundlers |
<!-- /BUILD:web-table -->
...
<!-- BUILD:web-options -->
**`fortune-nyx-v1.5.2-web.min.js`** — lightweight shell with IndexedDB VFS:

```html
<script type="module">
  import { createWebShell } from "./builds/fortune-nyx-v1.5.2-web.min.js";
...
**`fortune-nyx-v1.5.2-web.min.js`** — mirrors the `VirtualShell` programmatic API:

```html
<script type="module">
  import { createVirtualShellShim } from "./builds/fortune-nyx-v1.5.2-web.min.js";
...
<!-- BUILD:changelog -->
- [x] Web shell bundles (`fortune-nyx-v1.5.2-web.min.js`) — fully browser-native with IndexedDB VFS
- [x] Self-standalone CLI (`fortune-nyx-v1.5.2-directbash-k6.1.0.mjs`) — single-file interactive shell, per-user history, tab completion
<!-- /BUILD:changelog -->
