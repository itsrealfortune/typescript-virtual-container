...
| **Web shell** | `builds/fortune-nyx-v1.7.6-web.min.js` (ESM) | Embedded terminals, interactive tutorials, browser demos — run `startxfce4` for a full XFCE desktop |
| **Standalone CLI** | `builds/fortune-nyx-v1.7.6-directbash-k6.1.0.mjs` (single file) | Local shell, one-liner demos, no install required |
<!-- /BUILD:mode-table -->
...
|--------|--------|-------------|----------|
| `builds/fortune-nyx-v1.7.6-web.min.js` | ESM | `VirtualShell`, `VirtualFileSystem`, `SshClient`, `DesktopManager`, … | Embedded terminals, browser demos |
<!-- /BUILD:web-table -->
