...
<!-- BUILD:changelog -->
- [x] Web shell bundles (`fortune-nyx-v1.7.5-web.min.js`) — fully browser-native with IndexedDB VFS
- [x] Self-standalone CLI (`fortune-nyx-v1.7.5-directbash-k6.1.0.mjs`) — single-file interactive shell, per-user history, tab completion
<!-- /BUILD:changelog -->
...
- [x] Check for async functions that are not async, and then recursively transform await calls to async ones
</details>
